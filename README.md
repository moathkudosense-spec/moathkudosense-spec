  ...
  <table border="0">
    <tr>
      <td width="50%" valign="top">
        ...
        <ul>
          <li>Hardening Android Kernel Security</li>
          <li>Automating Network Vulnerability Scans</li>
          <li>Advanced Firmware Customization</li>
        </ul>
      </td>
      <td width="50%" valign="top">
        <h4>🛠️ Core Toolbelt</h4>
        <code>Python</code> <code>Linux/Kali</code> <code>ADB</code><br>
        <code>Odin</code> <code>Wireshark</code> <code>Git</code>
      </td>
    </tr>
  </table>
</div>
